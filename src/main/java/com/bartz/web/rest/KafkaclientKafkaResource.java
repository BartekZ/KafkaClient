package com.bartz.web.rest;

import com.bartz.config.KafkaProperties;
...
@RestController
@RequestMapping("/api/kafkaclient-kafka")
public class KafkaclientKafkaResource {

    private final Logger log = LoggerFactory.getLogger(KafkaclientKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaSender<String, String> sender;

    public KafkaclientKafkaResource(KafkaProperties kafkaProperties) {
